...
GUILD_ID = 1236613214779736064                    # Deine Server ID
GENERAL_CHANNEL_ID = 1236613215534841930
AFK_CHANNEL_ID = 1471282612373946491
ANNOUNCE_TEXT_CHANNEL_ID = 123456789012345678     # Falls du später Announcements brauchst
...
# ======================= LEADERBOARD =====================
def get_top_afk(month=None, limit=10):
    with db() as con:
        cur = con.cursor()
        if month:
            cur.execute("""
